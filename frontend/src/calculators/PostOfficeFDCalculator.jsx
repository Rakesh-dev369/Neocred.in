...
const PostOfficeFDCalculator = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto bg-gray-100 dark:bg-white/5 backdrop-blur-lg border border-gray-200 dark:border-white/10 rounded-xl p-6 shadow-lg mt-6">
      <h2 className="text-2xl font-bold mb-6 text-gray-900 dark:text-white">Post Office FD Calculator</h2>
            ...
            {({ isSubmitting }) => (
              <Form className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-700 dark:text-gray-300 mt-1">Quarterly compounding</p>
                </div>

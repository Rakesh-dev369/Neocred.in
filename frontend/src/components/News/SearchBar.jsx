      ...
      <form onSubmit={handleSubmit} className="mb-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-4 border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-900 dark:text-white dark:bg-gray-700 placeholder-gray-500 dark:placeholder-gray-400"
            disabled={loading}
          />
          {query && (
            <button

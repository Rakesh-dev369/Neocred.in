  ...
  return (
    ...
    >
      ...
      <p className="text-sm text-gray-600 dark:text-gray-300 mb-3">
        Get weekly financial tips and market insights
      </p>
      ...
      <form onSubmit={handleSubmit} className="flex gap-2">
        ...
        >
          <input
            ...
            className="w-full px-3 py-2 text-sm bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="px-4 py-2 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white text-sm font-medium rounded-lg transition-colors duration-200 min-w-[80px]"
        >
          {status === 'loading' ? (
            <motion.div
              animate={{ rotate: 360 }}
        ...
        <div className="border-t border-gray-300 dark:border-white/20 mt-8 pt-8">
          <div className="flex flex-col items-center space-y-4">
            <div className="flex items-center space-x-6">
              <motion.a 
                href="#" 
                className="group flex items-center justify-center w-10 h-10 rounded-full bg-blue-500 hover:bg-blue-600 transition-all duration-300"
              ...
              <motion.a 
                href="#" 
                className="group flex items-center justify-center w-10 h-10 rounded-full bg-blue-700 hover:bg-blue-800 transition-all duration-300"
                whileHover={{ scale: 1.1, rotate: 12 }}
                whileTap={{ scale: 0.95 }}
              >
                <motion.svg 
              ...
              <motion.a 
                ...
                className="group flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 transition-all duration-300"
                whileHover={{ scale: 1.1, rotate: 12 }}
                whileTap={{ scale: 0.95 }}
              >
                <motion.svg 

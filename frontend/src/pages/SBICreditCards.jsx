          ...
          {sbiCards.map((card, index) => (
            <div key={index} className="bg-white dark:bg-gray-800 rounded-xl p-8 shadow-lg">
              ...
              <div className="space-y-3">
                ...
                <button className="w-full border border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 py-3 px-6 rounded-lg font-medium transition-colors">
                  Compare Cards
                </button>
              </div>
            </div>

    ...
    >
      ...
      <div className={`flex items-center justify-between relative z-10 mt-auto ${
        ...
        <div className={`text-xs px-2 py-1 rounded-full ${
          ...
          <CountingNumber value={tool.popularity} duration={150} />% popular
        </div>
      </div>
      </motion.div>
    </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mobile-scroll-fix">
            <div className="text-center mb-12 relative">
              ...
              <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-500 dark:text-gray-400 mb-8">
                <span className="flex items-center gap-1">🟢 <CountingNumber value={allTools.filter(t => t.level === 'Beginner').length} duration={150} /> Beginner</span>
                <span className="flex items-center gap-1">🟡 <CountingNumber value={allTools.filter(t => t.level === 'Intermediate').length} duration={200} /> Intermediate</span>
                <span className="flex items-center gap-1">🔴 <CountingNumber value={allTools.filter(t => t.level === 'Advanced').length} duration={250} /> Advanced</span>
                <span className="flex items-center gap-1">🔥 <CountingNumber value={allTools.filter(t => t.popularity > 85).length} duration={300} /> Popular</span>
              </div>
            </div>
            ...
            {userPoints > 0 && (
              <div className="mb-8 flex justify-center">
                <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-xl inline-flex items-center gap-2 px-4 py-2 relative">
                  ...
                  <span className="text-yellow-600 dark:text-yellow-400 font-bold"><CountingNumber value={userPoints} duration={200} /></span>
            ...
            <div className="mb-8 relative">
              ...
              >
                ...
                <motion.span 
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <CountingNumber value={filteredTools.length} duration={100} /> tools found
                </motion.span>
              </motion.div>
            </div>

      ...
      <section className="py-20 bg-gradient-to-b from-blue-100/50 to-gray-200 dark:from-blue-900/20 dark:to-black">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-5xl md:text-6xl font-bold mb-6">
            About <span className="text-blue-400">NeoCred</span>
          </h1>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-16">
          ...
          <section className="text-center">
            ...
            <div className="glass-card max-w-4xl mx-auto">
              <p className="text-lg mb-6 leading-relaxed text-gray-700 dark:text-gray-300">
                At NeoCred, we believe that financial literacy is the first step toward financial freedom. 
          ...
          <section>
            ...
            <div className="glass-card mt-8 text-center">
              <p className="text-lg text-gray-700 dark:text-gray-300">
                ...
                <span className="text-blue-600 dark:text-blue-400 font-semibold"> NeoCred is your friendly companion</span> on the journey to smarter financial decisions.
              </p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="text-center text-xl text-gray-700 dark:text-gray-300 mb-12">NeoCred is a growing platform focused on:</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              <div className="glass-card hover:bg-white/10 transition-all duration-300 group">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">Easy-to-understand lessons across 8 core financial categories</p>
              </div>
              ...
              <div className="glass-card hover:bg-white/10 transition-all duration-300 group">
                ...
                <p className="text-gray-700 dark:text-gray-300 text-sm">News, schemes, tips from RBI, SEBI, PIB</p>
              </div>
              
              <div className="glass-card hover:bg-white/10 transition-all duration-300 group">
                <div className="text-3xl mb-4 group-hover:scale-110 transition-transform">🤖</div>
                <h3 className="text-lg font-semibold mb-2 text-purple-400">AI Assistant</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">AI-powered guidance and explainers</p>
              </div>
              
              <div className="glass-card hover:bg-white/10 transition-all duration-300 group">
                <div className="text-3xl mb-4 group-hover:scale-110 transition-transform">🌍</div>
                <h3 className="text-lg font-semibold mb-2 text-purple-400">Inclusive Design</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Built for Tier-2/Tier-3 cities and local users</p>
              </div>
              
              <div className="glass-card hover:bg-white/10 transition-all duration-300 group">
                <div className="text-3xl mb-4 group-hover:scale-110 transition-transform">🎆</div>
                <h3 className="text-lg font-semibold mb-2 text-purple-400">Rewards System</h3>
                <p className="text-gray-700 dark:text-gray-300 text-sm">Gamified learning with points and achievements</p>
              </div>
            </div>
          </section>
            ...
            <div className="glass-card text-center max-w-3xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div className="flex items-center justify-center gap-3 p-4 bg-white/5 rounded-lg">
                  <div className="text-2xl">⏰</div>
                  <div className="text-left">
                    <p className="text-gray-900 dark:text-white font-medium">Response Time</p>
                    <p className="text-gray-700 dark:text-gray-300">Within 24 hours</p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
              <div className="glass-card">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">Software Engineer, Bangalore</p>
                  </div>
                </div>
                <p className="text-gray-700 dark:text-gray-300 text-sm italic mb-3">
                  "NeoCred helped me understand SIP investments. I started with ₹2000/month and now I'm confident about my financial future!"
                </p>
              ...
              <div className="glass-card">
                <div className="flex items-center gap-3 mb-4">
                  <div className="text-3xl">👨‍🎓</div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">Rahul K.</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Student, Delhi</p>
                  </div>
                </div>
                <p className="text-gray-700 dark:text-gray-300 text-sm italic mb-3">
              ...
              <div className="glass-card">
                <div className="flex items-center gap-3 mb-4">
                  <div className="text-3xl">👩‍🏫</div>
                  <div>
                    <p className="font-semibold text-gray-900 dark:text-white">Anita M.</p>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Teacher, Pune</p>
                  </div>
                </div>
                <p className="text-gray-700 dark:text-gray-300 text-sm italic mb-3">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="glass-card text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-blue-600 dark:text-blue-300 font-medium mb-3">Founder & Visionary</p>
              ...
              <div className="glass-card text-center hover:scale-105 transition-all duration-300">
                ...
                <p className="text-purple-600 dark:text-purple-300 font-medium mb-3">Content & Research</p>
                <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed mb-4">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  <div className="bg-yellow-500/20 p-2 rounded">
                    ...
                    <div className="text-gray-600 dark:text-gray-400">Feedback Items</div>
                  </div>
          ...
          <section className="text-center">
            <div className="glass-card">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  to={ROUTES.TOOLS}
                  className="border-2 border-gray-900 dark:border-white text-gray-900 dark:text-white hover:bg-gray-900 hover:text-white dark:hover:bg-white dark:hover:text-black font-medium py-3 px-8 rounded-lg transition-all duration-300 inline-flex items-center justify-center gap-2"
                >
                  🧮 Try Our Tools
                </Link>
                <Link

        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <div className="glass-card hover:scale-105 transition-all duration-300">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm">Your data is encrypted and protected</p>
            </div>
            
            <div className="glass-card hover:scale-105 transition-all duration-300">
              <div className="text-3xl mb-3">🚫</div>
              <h3 className="text-lg font-semibold mb-2 text-red-400">No Data Selling</h3>
              <p className="text-gray-700 dark:text-gray-300 text-sm">We never sell or trade your information</p>
            </div>
            
            <div className="glass-card hover:scale-105 transition-all duration-300">
              <div className="text-3xl mb-3">🇮🇳</div>
              <h3 className="text-lg font-semibold mb-2 text-blue-400">India Compliant</h3>
              <p className="text-gray-700 dark:text-gray-300 text-sm">Follows DPDP Act and global standards</p>
            </div>
          </div>
            ...
            <div className="space-y-12">
              ...
              <div className="glass-card">
                <p className="text-lg mb-6 leading-relaxed text-gray-700 dark:text-gray-300">
                  Welcome to NeoCred — where we help you learn and manage your finances, one step at a time.
                </p>
              ...
              <section id="who-we-are" className="glass-card">
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300 leading-relaxed">
                  <p>
                    NeoCred is a financial education and awareness platform designed for India. We are a non-certified, 
              ...
              <section id="what-we-collect" className="glass-card">
                ...
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse border border-gray-300 dark:border-white/20 rounded-lg overflow-hidden">
                    <thead>
                      <tr className="bg-gray-100 dark:bg-white/10">
                        <th className="border border-gray-300 dark:border-white/20 px-4 py-3 text-left font-semibold text-gray-900 dark:text-white">Type of Data</th>
                        <th className="border border-gray-300 dark:border-white/20 px-4 py-3 text-left font-semibold text-gray-900 dark:text-white">Examples</th>
                        <th className="border border-gray-300 dark:border-white/20 px-4 py-3 text-left font-semibold text-gray-900 dark:text-white">Why We Collect It</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 font-medium text-gray-900 dark:text-white">Basic Info</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">Name, email (if you sign up or contact us)</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">To personalize your experience or respond to queries</td>
                      </tr>
                      <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 font-medium text-gray-900 dark:text-white">Technical Info</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">IP, browser type, device</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">To keep the site secure and understand usage trends</td>
                      </tr>
                      <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 font-medium text-gray-900 dark:text-white">Usage Data</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">What pages you visit, clicks</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">To improve features and user experience</td>
                      </tr>
                      <tr className="hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 font-medium text-gray-900 dark:text-white">Feedback</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">Messages, form inputs</td>
                        <td className="border border-gray-300 dark:border-white/20 px-4 py-3 text-gray-700 dark:text-gray-300">To enhance tools and content based on your needs</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
              ...
              <section id="data-protection" className="glass-card">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-4">Your data is protected using bank-level security measures:</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-green-400">✅</span>
                      <span className="font-medium text-gray-900 dark:text-white">SSL Encryption</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">HTTPS across the entire site</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-green-400">✅</span>
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-sm">For sensitive input data</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-green-400">✅</span>
                      <span className="font-medium text-gray-900 dark:text-white">Secure Servers</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">With access control</p>
                  </div>
                  <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                    <div className="flex items-center gap-2 mb-2">
                      <span className="text-red-400">🚫</span>
                      <span className="font-medium text-gray-900 dark:text-white">No Financial Data</span>
                    </div>
                    <p className="text-gray-600 dark:text-gray-400 text-sm">No account details, OTPs, cards, PAN/Aadhaar</p>
                  </div>
                </div>
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-blue-600/20 border border-blue-500/30 rounded-lg p-4">
                      <h4 className="font-semibold text-blue-600 dark:text-blue-300 mb-2">🎆 Platform Improvement</h4>
                    ...
                    <div className="bg-green-600/20 border border-green-500/30 rounded-lg p-4">
                      <h4 className="font-semibold text-green-600 dark:text-green-300 mb-2">📞 Communication</h4>
                      <ul className="text-sm space-y-1 text-gray-700 dark:text-gray-300">
                    ...
                    <div className="bg-purple-600/20 border border-purple-500/30 rounded-lg p-4">
                      <h4 className="font-semibold text-purple-600 dark:text-purple-300 mb-2">🔒 Security</h4>
                      <ul className="text-sm space-y-1 text-gray-700 dark:text-gray-300">
                    ...
                    <div className="bg-yellow-600/20 border border-yellow-500/30 rounded-lg p-4">
                      <h4 className="font-semibold text-yellow-600 dark:text-yellow-300 mb-2">📊 Analytics</h4>
                      <ul className="text-sm space-y-1 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-medium text-blue-600 dark:text-blue-300">Access Your Data</span>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">Request a copy of all data we hold about you</p>
                    </div>
                    <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-green-400">✏️</span>
                        <span className="font-medium text-green-600 dark:text-green-300">Correct Your Data</span>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">Update or correct any inaccurate information</p>
                    </div>
                    <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-red-400">🗑️</span>
                        <span className="font-medium text-red-600 dark:text-red-300">Delete Your Data</span>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">Request deletion of your personal information</p>
                    </div>
                  </div>
                  <div className="space-y-4">
                    <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="font-medium text-yellow-600 dark:text-yellow-300">Data Portability</span>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">Export your data in a readable format</p>
                    </div>
                    <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-purple-400">❌</span>
                        <span className="font-medium text-purple-600 dark:text-purple-300">Opt-Out</span>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">Withdraw consent for data processing</p>
                    </div>
                    <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="text-orange-400">📞</span>
                        <span className="font-medium text-orange-600 dark:text-orange-300">File Complaints</span>
                      </div>
                      <p className="text-gray-600 dark:text-gray-400 text-sm">Report privacy concerns to authorities</p>
                    </div>
                  </div>
                </div>
              ...
              <section id="data-breach" className="glass-card">
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="bg-red-600/20 border border-red-500/30 rounded-lg p-4">
                    <div className="flex items-start justify-center gap-3">
                      ...
                      <div className="text-center">
                        <h4 className="font-semibold text-red-600 dark:text-red-300 mb-2">Our Response Protocol</h4>
                        <ul className="text-red-800 dark:text-red-100 text-sm space-y-1 text-left inline-block">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-blue-600/20 border border-blue-500/30 rounded-lg p-4">
                      <h4 className="font-semibold text-blue-600 dark:text-blue-300 mb-2">📞 What We'll Tell You</h4>
                    ...
                    <div className="bg-green-600/20 border border-green-500/30 rounded-lg p-4">
                      <h4 className="font-semibold text-green-600 dark:text-green-300 mb-2">🛡️ Prevention Measures</h4>
                      <ul className="text-green-800 dark:text-green-100 text-sm space-y-1">
              ...
              <section id="policy-changes" className="glass-card">
                ...
                <div className="space-y-4 text-gray-700 dark:text-gray-300">
                  ...
                  <div className="bg-yellow-600/20 border border-yellow-500/30 rounded-lg p-4">
                    <h4 className="font-semibold text-yellow-600 dark:text-yellow-300 mb-2">🔔 How We Notify You</h4>
                    <ul className="text-yellow-800 dark:text-yellow-100 text-sm space-y-1">
              ...
              <section id="contact" className="glass-card">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-6">If you have questions or concerns about your data or this policy, reach out:</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                  ...
                  <div className="bg-gray-100 dark:bg-white/5 p-4 rounded-lg">
                    <div className="flex items-center gap-3 mb-2">
                      <span className="text-2xl">🌐</span>
                      <span className="font-medium text-gray-900 dark:text-white">Policy Page</span>
                    </div>
                    <a href="https://neocred.in/privacy" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                      neocred.in/privacy
                    </a>
                  </div>
                </div>

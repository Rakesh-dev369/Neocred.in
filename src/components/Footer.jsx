      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold text-white mb-4">Savely</h3>
          ...
          <div>
            ...
            <div className="text-gray-300">
              ...
              <Link to={ROUTES.LEARN} className="hover:text-white transition-colors">Learn</Link>
              <span className="mx-2">|</span>
              <Link to={ROUTES.TOOLS} className="hover:text-white transition-colors">Tools</Link>
              <span className="mx-2">|</span>
              <Link to={ROUTES.CHATBOT} className="hover:text-white transition-colors">AI Assistant</Link>
              <span className="mx-2">|</span>
              <Link to={ROUTES.NEWS} className="hover:text-white transition-colors">News</Link>
              <span className="mx-2">|</span>
          ...
          <div>
            ...
            <div className="text-gray-300">
              ...
              <span className="mx-2">|</span>
              <Link to={ROUTES.COOKIES} className="hover:text-white transition-colors">Cookies Policy</Link>
              <span className="mx-2">|</span>
              <Link to={ROUTES.CONTACT} className="hover:text-white transition-colors">Contact Us</Link>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/20 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © {new Date().getFullYear()} Savely. All rights reserved.
          </p>
        </div>
      </div>
    </footer>

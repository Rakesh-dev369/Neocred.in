...
const CarBikeLoanEMICalculator = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto glass-card mt-6">
      <h2 className="text-2xl font-bold mb-6 text-white">Car/Bike Loan EMI Calculator</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Input Section */}
        <div className="glass-card">
          <h3 className="text-xl font-semibold mb-6 text-white">🚗 Car/Bike Loan EMI Calculator</h3>
            ...
            <div className="glass-card">
              ...
              <div className="mt-6 p-4 bg-orange-900/20 border border-orange-500/30 rounded-lg">
                <p className="text-orange-100 text-sm">
                  🚗 <strong>Vehicle Tip:</strong> Consider down payment, insurance, and registration costs in your budget planning.
                </p>
              </div>
            </div>
              ...
              <ResponsiveContainer width="100%" height={250}>
                <BarChart data={result.data} margin={{ top: 10, right: 10, left: 10, bottom: 5 }}>
                  ...
                  <Bar 
                    dataKey="amount" 
                    radius={[4, 4, 0, 0]}
                    fill="url(#vehicleLoanGradient)"
                  />
                  <defs>
                    <linearGradient id="vehicleLoanGradient" x1="0" y1="0" x2="0" y2="1">

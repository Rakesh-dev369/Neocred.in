...
const EmergencyFundCalculator = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto glass-card mt-6">
      <h2 className="text-2xl font-bold mb-6 text-white">Emergency Fund Calculator</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Input Section */}
        <div className="glass-card">
          <h3 className="text-xl font-semibold mb-6 text-white">🛡️ Emergency Fund Calculator</h3>
            ...
            {({ isSubmitting }) => (
              <Form className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">Include rent, food, utilities, EMIs, etc.</p>
                </div>
        ...
        {result && (
          <div className="space-y-6">
            <div className="glass-card">
              <h3 className="text-lg font-semibold text-white mb-4">Emergency Fund Plan</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-white/20">
                  <span className="text-white/80">Monthly Expenses:</span>
                  <span className="text-blue-400 font-semibold">₹{result.monthlyExpenses.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-white/20">
                  <span className="text-white/80">Coverage Period:</span>
                  <span className="text-white font-semibold">{result.months} months</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-white/20">
                  <span className="text-white/80">Emergency Fund Needed:</span>
                  <span className="text-green-400 font-bold text-xl">₹{result.totalFund.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-white/80">Monthly Savings Target:</span>
                  <span className="text-yellow-400 font-bold text-lg">₹{result.monthlyTarget.toLocaleString()}</span>
                </div>
              </div>
            ...
            <div className="glass-card">
              <h3 className="text-lg font-semibold text-white mb-4 text-center">Emergency Fund Options</h3>

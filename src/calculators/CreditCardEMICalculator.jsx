...
const CreditCardEMICalculator = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto glass-card mt-6">
      <h2 className="text-2xl font-bold mb-6 text-white">Credit Card EMI Calculator</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Input Section */}
        <div className="glass-card">
          <h3 className="text-xl font-semibold mb-6 text-white">💳 Credit Card EMI Calculator</h3>
        ...
        {result && (
          <div className="space-y-6">
            ...
            <div className="glass-card">
              <h3 className="text-lg font-semibold text-white mb-4 text-center">EMI Breakdown</h3>

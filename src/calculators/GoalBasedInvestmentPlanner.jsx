...
const GoalBasedInvestmentPlanner = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto glass-card mt-6">
      <h2 className="text-2xl font-bold mb-6 text-white">Goal-Based Investment Planner</h2>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Input Section */}
        <div className="glass-card">
          <h3 className="text-xl font-semibold mb-6 text-white">🎯 Goal-Based Investment Planner</h3>
        ...
        {result && (
          <div className="space-y-6">
            <div className="glass-card">
              <h3 className="text-lg font-semibold text-white mb-4">Investment Plan</h3>
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-white/20">
                  <span className="text-white/80">Monthly Investment Required:</span>
                  <span className="text-blue-400 font-semibold">₹{result.monthlyInvestment.toLocaleString()}</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-white/20">
                ...
                <div className="flex justify-between items-center py-2">
                  <span className="text-white/80">Goal Amount:</span>
                  <span className="text-yellow-400 font-bold text-lg">₹{result.goalAmount.toLocaleString()}</span>
                </div>
              </div>
            ...
            <div className="glass-card">
              <h3 className="text-lg font-semibold text-white mb-4 text-center">Goal vs Investment</h3>

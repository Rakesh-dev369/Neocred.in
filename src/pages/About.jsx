    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="space-y-16">
          ...
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-yellow-400">💎 What We Stand For</h2>
            <ul className="list-none pl-0 mb-4 space-y-2">
              <li><strong>Transparency</strong> – We don't collect financial data unnecessarily</li>
              <li><strong>Privacy</strong> – Your information is protected with bank-level security</li>
              <li><strong>Simplicity</strong> – No jargon. No sales. Just clear financial help</li>
              <li><strong>Accessibility</strong> – Free for everyone, forever</li>
            </ul>
          </div>
